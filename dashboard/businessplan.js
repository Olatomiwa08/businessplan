...
const businessplan = ` <div class="businessplan">
<div class="download">
...
<div class="addsection">
    ...
    <button class="section">
        <svg xmlns="http://www.w3.org/2000/svg" class="menu" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
